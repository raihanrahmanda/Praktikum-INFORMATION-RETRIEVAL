...
def main():
    with sync_playwright() as p:
        ...
        for listing in listings:
            ...
            reviews_scores = '//*[@id="QA0Szd"]/div/div/div[1]/div[3]/div/div[1]/div/div/div[2]/div[2]/div/div[1]/div[2]/div/div[1]/div[2]/span[1]/span[1]'
            ...
            if listing.locator(reviews_span_xpath).count() > 0:
                business.reviews_average = page.locator(reviews_scores).inner_text()
