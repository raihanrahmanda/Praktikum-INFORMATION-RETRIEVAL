...
def main():
  ...
  print("\nSkor top 3 berita yang paling relevan dengan query menggunakkan standar likelihood query model: ")
  print(exact_top_k_likelihood(doc_dict, likelihood_scores, 3))

  likelihood_scores_laplace = likelihood_laplace(tokenized_query, doc_dict, vocab, 1)
  print("\nSkor top 3 berita yang paling relevan dengan query menggunakkan Laplace Smoothing: ")
  print(exact_top_k_likelihood(doc_dict, likelihood_scores_laplace, 3))

  likelihood_scores_jm = likelihood_jm(tokenized_query, tokenized_corpus, doc_dict, 0.5)
  print("\nSkor top 3 berita yang paling relevan dengan query menggunakkan Jelinek-Mercer Smoothing: ")
  print(exact_top_k_likelihood(doc_dict, likelihood_scores_jm, 3))

  likelihood_scores_dirichlet = likelihood_dirichlet(tokenized_query, tokenized_corpus, doc_dict, 2)
  print("\nSkor top 3 berita yang paling relevan dengan query menggunakkan Dirichlet Smoothing: ")
